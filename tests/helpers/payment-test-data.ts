...
export async function ensurePaymentTestPlans() {
  await getDb().insert(platformPlans).values([
    { code: "starter", nameAr: "البداية", nameEn: "Starter", priceEgp: 199, guestLimit: 50, durationDays: 365, position: 1, featuresAr: [], featuresEn: [] },
    { code: "elegant", nameAr: "الأنيقة", nameEn: "Elegant", priceEgp: 599, guestLimit: 250, durationDays: 365, position: 2, featured: true, featuresAr: [], featuresEn: [] },
