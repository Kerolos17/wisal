...
- Chosen direction: **Editorial Atelier / مشغل التحرير الاحتفالي**. Six authored invitation artifacts ship in the initial collection inside the broader Celestial Guest Atlas product system. They share dependable guest-flow structure but do not share one universal visual shell.
